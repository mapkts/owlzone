...
/* header.js */
!function(){var e,s=$("#header"),a=$(".header-topbar"),o=$(".opacity-mask"),i=$(".widget-area"),n=$(window),t=s.rect().height-a.rect().height,l=!1,r=!1;function c(){(e=pageYOffset/t)<=1?(o.css("opacity",e),a.removeClass("topbar-shadow")):a.addClass("topbar-shadow"),l=!1}function d(){280<pageYOffset&&!i.hasClass("fixed")?i.addClass("fixed").css("top","50px"):pageYOffset<280&&i.hasClass("fixed")&&i.removeClass("fixed")}n.on("scroll",function(){l||(requestAnimationFrame(c),requestAnimationFrame(d),l=!0)}),c(),n.on("resize",function(){r=!0}),setInterval(function(){r&&(r=!1,t=s.rect().height-a.rect().height,c())},2e3)}(),function(){var s=$("#nav-main"),a=$("#nav-icon"),o=$(".opacity-overlay"),i=$("body");a.on("click",function(e){s.toggleClass("nav-dropdown"),i.toggleClass("no-scroll")}),document.addEventListener("click",function(e){a[0].contains(e.target)||(s.removeClass("nav-dropdown"),o.removeClass("overlay-display").removeClass("overlay-finale"))})}(),function(){var e=document.getElementById("nav-icon"),s=document.getElementsByClassName("opacity-overlay")[0];e.addEventListener("click",function(){s.classList.contains("overlay-display")?s.classList.remove("overlay-display","overlay-finale"):(s.classList.add("overlay-display"),setTimeout(function(){s.classList.toggle("overlay-finale")},500))})}(),function(){var e=$("#trigger-search"),s=$("#collapse-search"),a=$("#search-field"),o=$(".logo");e.on("click",function(){e.addClass("search-hidden"),s.addClass("search-visible"),a.addClass("search-visible"),o.addClass("logo-responsive")}),s.on("click",function(){e.removeClass("search-hidden"),s.removeClass("search-visible"),a.removeClass("search-visible"),o.removeClass("logo-responsive")})}();
