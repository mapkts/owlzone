...
/* header.js */
!function(){var e,a=$("#header"),s=$(".header-topbar"),o=$(".opacity-mask"),i=$(".widget-area"),n=$(window),t=a.rect().height-s.rect().height,l=!1,r=!1;function c(){(e=pageYOffset/t)<=1?(o.css("opacity",e),s.removeClass("topbar-shadow")):s.addClass("topbar-shadow"),l=!1}function d(){pageYOffset>280&&!i.hasClass("fixed")?i.addClass("fixed").css("top","50px"):pageYOffset<280&&i.hasClass("fixed")&&i.removeClass("fixed")}n.on("scroll",function(){l||(requestAnimationFrame(c),requestAnimationFrame(d),l=!0)}),c(),n.on("resize",function(){r=!0}),setInterval(function(){r&&(r=!1,t=a.rect().height-s.rect().height,c())},2e3)}(),function(){var e=$("#nav-main"),a=$("#nav-icon"),s=$(".opacity-overlay");a.on("click",function(a){e.toggleClass("nav-dropdown")}),document.addEventListener("click",function(o){a[0].contains(o.target)||(e.removeClass("nav-dropdown"),s.removeClass("overlay-display").removeClass("overlay-finale"))})}(),function(){var e=document.getElementById("nav-icon"),a=document.getElementsByClassName("opacity-overlay")[0];e.addEventListener("click",function(){a.classList.contains("overlay-display")?a.classList.remove("overlay-display","overlay-finale"):(a.classList.add("overlay-display"),setTimeout(function(){a.classList.toggle("overlay-finale")},500))})}(),function(){var e=$("#trigger-search"),a=$("#collapse-search"),s=$("#search-field"),o=$(".logo");e.on("click",function(){e.addClass("search-hidden"),a.addClass("search-visible"),s.addClass("search-visible"),o.addClass("logo-responsive")}),a.on("click",function(){e.removeClass("search-hidden"),a.removeClass("search-visible"),s.removeClass("search-visible"),o.removeClass("logo-responsive")})}();
